...
export default function StaffVerificationList() {
  ...
  const verificationQueue = useMemo(() => {
    return orders
      .filter(o => ['verifying', 'reviewing'].includes(o.status))
  ...
  const getStatusIcon = (status) => {
    switch(status) {
      case 'verifying': return <CheckCircle2 size={16} className="text-blue-500" />;
      case 'reviewing': return <PenTool size={16} className="text-orange-500" />;
      default: return null;
    }
  };
