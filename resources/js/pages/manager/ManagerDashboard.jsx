...
export default function ManagerDashboard() {
  ...
  // Mock revenue calculation from completed orders
  const totalRevenue = orders
    .filter(o => o.status === 'completed')
    .reduce((acc, order) => acc + order.total, 0) || 12500000; // Mock base

  const activeOrders = orders.filter(o => ['verifying', 'reviewing', 'production'].includes(o.status)).length;
        ...
        <FadeIn delay={0.5} className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
          ...
          <div className="space-y-6">
            {[
              ...
              { name: 'Spanduk Kain Pecel Lele', sales: 64, revenue: 'Rp 1.800.000', img: 'https://images.unsplash.com/photo-1542106680-36e76fc6d8f5?q=80&w=200&auto=format&fit=crop' },
              { name: 'Kartu Nama Premium', sales: 42, revenue: 'Rp 850.000', img: 'https://images.unsplash.com/photo-1616423640778-28d1b53229bd?q=80&w=200&auto=format&fit=crop' },
            ].map((prod, idx) => (
