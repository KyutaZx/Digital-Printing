...
<div class="space-y-6 fade-in pb-8" x-data="{ tab: 'revenue' }">
    ...
    <div class="flex flex-col lg:flex-row lg:items-end justify-between gap-4">
        <div>
            <h1 class="text-2xl font-black text-slate-900 tracking-tight">Analisis Laporan & Riwayat</h1>
            <p class="text-xs text-slate-500 mt-1">Monitoring performa toko digital printing secara real-time</p>
        </div>
