...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
    @php
    $cards = [
        ['label' => 'Menunggu Verifikasi', 'value' => $stats['menunggu_verifikasi'], 'color' => 'yellow', 'icon' => 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z'],
        ['label' => 'Sedang Dicetak',      'value' => $stats['sedang_cetak'],        'color' => 'blue',   'icon' => 'M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z'],
        ['label' => 'Siap Diambil',        'value' => $stats['siap_ambil'],          'color' => 'green',  'icon' => 'M5 13l4 4L19 7'],
        ['label' => 'Selesai',             'value' => $stats['selesai_hari_ini'],    'color' => 'purple', 'icon' => 'M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z'],
    ];
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
    <a href="/staff/verifikasi" class="card p-5 flex items-center gap-4 hover:shadow-md hover:-translate-y-0.5 transition-all group">
        ...
        <div>
            <p class="font-bold text-slate-900 text-sm group-hover:text-primary-600 transition-colors">Verifikasi Pembayaran</p>
            <p class="text-xs text-slate-500">{{ $stats['menunggu_verifikasi'] }} pesanan menunggu</p>
        </div>
    ...
    <a href="/staff/produksi" class="card p-5 flex items-center gap-4 hover:shadow-md hover:-translate-y-0.5 transition-all group">
        ...
        <div>
            ...
            <p class="text-xs text-slate-500">{{ $stats['sedang_cetak'] }} sedang dicetak</p>
        </div>
        <svg class="w-4 h-4 text-slate-300 ml-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
    </a>
</div>
...
<div class="card">
    <div class="px-6 py-4 border-b border-slate-100 flex items-center justify-between">
        ...
        <a href="/staff/verifikasi" class="text-sm text-primary-600 hover:text-primary-700 font-semibold">Lihat Semua</a>
    </div>
    <div class="overflow-x-auto">
        <table class="w-full text-sm">
            ...
            <tr class="hover:bg-slate-50 transition-colors">
                ...
                <td class="px-6 py-4">
                    <a href="/staff/verifikasi/{{ $order['id'] }}" class="text-xs font-semibold text-primary-600 hover:text-primary-700">Detail →</a>
                </td>
            </tr>
            @empty
