                    ...
                    <div class="pt-6 border-t border-slate-100 mt-6">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4">
                            @if(session('user'))
                                ...
                                <button type="submit" formaction="/pesanan/beli-sekarang" name="action" value="buy" class="flex-1 bg-primary-600 hover:bg-primary-700 text-white font-bold rounded-xl py-4 shadow-lg shadow-primary-200 flex items-center justify-center transition-all">
                                    Beli Sekarang
                                </button>
                            @else
